...
// ----------------declaration merging---------------: Hop 2 interface trung ten thanh 1
  // interface user{
  //   readonly id: string,
  //   name: string
  // }
...
// ----------------utility type---------------
  //partial: Chuyển tất cả các thuộc tính thanh optional
  // interface User{
  //   name: string,
  //   email: string,
  //   phone: string
  ...
  //required: Chuyển tất cả các thuộc tính thành bắt buộc
  // interface User{
  //   name: string,
  //   email?: string,
  //   phone: string
  ...
  //Omit: Loại trừ 1 key ra khỏi interface
  // interface User{
  //   name: string,
  //   email?: string,
  //   phone: string,
  //   hobby: string
  // }
  // const user1:Omit<User,"hobby"|"email">={
  //   name: "tung",
  //   phone:"123"
  // }

  //Pick: Chỉ giữ lại những thuộc tính được chọn
  // interface User{
  //   name: string,
  //   email?: string,
  //   phone: string,
  ...
  //Readonly: Chuyển hết các thuộc tính thành dạng readonly
  // interface User{
  //   name: string,
  //   email?: string,
  //   phone: string,
